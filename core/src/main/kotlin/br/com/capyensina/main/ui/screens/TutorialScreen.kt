...
class TutorialScreen (main: Main) : KtxScreen {
    ...
    //interface tela
    private val infoboxum = Texture("infoboxum.png".toInternalFile())
    private val closebutton = Texture("closebutton.png".toInternalFile())
    private val skipbutton = Texture("skipbutton.png".toInternalFile())
    ...
    private fun checkButtonClick() {
        if (Gdx.input.justTouched()) {
            ...
            //botao de close
            if (x in 1000f..1400f && y in (Gdx.graphics.height - 2060f)..(Gdx.graphics.height - 1870f)) {
    ...
    private fun draw(){
        ...
        batch.use {
            ...
            it.draw(infoboxum, 5f, 800f, 1350f, 1500f)
            it.draw(closebutton, 1000f, 1690f, 400f, 400f)
            it.draw(skipbutton, 700f, 300f, 800f, 800f)
